...
<div class="text-2xl- space-y-2">
	<div class=" border-t- border-b pt-1 pb-32">
		<div class=" gap-y-0! text-2xl/7">
			{#each data.ressources as ressource}
				<div class="col-span-6 flex items-center gap-4">
					<div class="size-5 rounded-full bg-text"></div>
					<div>
	...
	<div>
		<div class="grid-12 text-balance">
			...
			<div
				class=" col-span-full col-start-1 max-md:mb-16 md:col-span-6 xl:col-span-6 xl:col-start-4"
			>
