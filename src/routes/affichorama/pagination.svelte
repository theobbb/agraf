<script lang="ts">
	...
	import IconChevronLeftDouble from '$lib/ui/icons/icon-chevron-left-double.svelte';
	import IconChevronLeft from '$lib/ui/icons/icon-chevron-left.svelte';
	import IconChevronRightDouble from '$lib/ui/icons/icon-chevron-right-double.svelte';
