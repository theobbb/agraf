...
<header
	class={[
		'-mt-1.5- px-layout-x- sticky top-0 z-100 -mx-layout-x  border-b bg-bg  ',
		scrolled && 'border-b'
	]}
>
	<div class="gap-4- flex">
		{#each links as { name, href }, i}
			<a
				{href}
				class={[
					'-mb-px cursor-pointer border-r border-b border-x-transparent  px-3 py-1.5 text-left first:border-l',
